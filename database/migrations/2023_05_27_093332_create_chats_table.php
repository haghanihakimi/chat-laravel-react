...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('chats', function (Blueprint $table) {
            $table->id();
            $table->foreignId('sender_chat_key')->nullable()->default(null)->constrained('chat_keys')->onDelete('cascade');
            $table->foreignId('recipient_chat_key')->nullable()->default(null)->constrained('chat_keys')->onDelete('cascade');
