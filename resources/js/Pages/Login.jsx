                ...
                <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                  <form>
                    <div
                      ...
                      <p className="mb-0 mr-4 text-lg text-black dark:text-milky-milky-white">Sign in with</p>
                      <button
                        type="button"
                        data-te-ripple-init
                    ...
                    <div
                      className="my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-black before:border-opacity-30 before:dark:border-milky-milky-white before:dark:border-opacity-30 after:mt-0.5 after:flex-1 after:border-t after:border-black after:border-opacity-30 after:dark:border-milky-milky-white after:dark:border-opacity-30">
                      <p
                        className="mx-4 mb-0 text-black text-center font-semibold dark:text-milky-milky-white">
                        Or
                      </p>
                    </div>
